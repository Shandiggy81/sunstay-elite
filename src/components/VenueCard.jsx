                    ...
                    >
                        <div className={`relative flex-1 min-h-0 bg-white rounded-t-[40px] shadow-[-10px_0_30px_rgba(0,0,0,0.15)] border-t ${cardAccent} flex flex-col overflow-hidden mx-auto max-w-2xl w-full`}>
                            ...
                            >
                                ...
                                <div className="mt-12 mb-20 border-t border-gray-100 pt-10" ref={bookingRef}>
                                    ...
                                    <div className="bg-white border border-gray-100 rounded-[32px] p-6 sm:p-8 pb-32 pt-10 shadow-xl shadow-orange-900/5 transition-all">
                                        {bookingSuccess ? (
                                            <motion.div
                                            ...
                                            <div className="flex flex-col gap-6">
                                                ...
                                                <button
                                                    ...
                                                    className="w-full h-16 mt-4 bg-emerald-600 hover:bg-emerald-700 text-white font-black text-[13px] uppercase tracking-[0.25em] rounded-2xl shadow-lg shadow-emerald-500/20 transition-all flex items-center justify-center gap-3 group disabled:opacity-70 disabled:grayscale overflow-hidden relative"
                                                >
                                                    {isBookingLoading ? (
